...
public class AddPaquete extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AddPaquete dialog = new AddPaquete(null, true);
	 ...
	 * Create the dialog.
	 */
	public AddPaquete(javax.swing.JFrame parent, boolean modal) {
		super(parent, modal);
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					paquete.setTotalLlamadasLocales(totalLlamadasLocales);
					paquete.setMinutosLDN(minutosLDN);
					paquete.setMinutosLDI(minutosLDI);
					paquete.setMinutosCelular(minutosCelular);
					paquete.setInfinitum(infinitum);
					paquete.setServiciosDigitales(serviciosDigitales);
					paquete.setMbInfinitum(mbInfinitum);
