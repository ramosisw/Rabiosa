...
public class ModificCliente extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificCliente dialog = new ModificCliente(null, true);
	 ...
	 * Create the dialog.
	 */
	public ModificCliente(javax.swing.JFrame parent, boolean modal) {
		super(parent, modal);
	...
	protected boolean estadoChange() {
		Estado estado = (Estado) comboBoxEstado.getSelectedItem();
		ClientePersistencia cp = new ClientePersistencia();
	...
	protected boolean municipioChage() {
	...
	protected boolean poblacionChange() {
	...
	protected boolean loadColonias() {
		ClientePersistencia cp = new ClientePersistencia();
	...
	public Component setCliente(Cliente cliente) {
		loadColonias();
		this.cliente_o=cliente;
		this.textNombre.setText(cliente.getNombre());
		this.textRFC.setText(cliente.getRfc());
		this.textLada.setText(cliente.getLada()+"");
		this.textCalle.setText(cliente.getDireccion().getCalle());
		this.textTelefono.setText(cliente.getTelefono()+"");
		this.textNumero.setText(cliente.getDireccion().getNumero());
		this.comboBoxEstado.setSelectedItem(cliente.getDireccion().getColonia().getPoblacion().getMunicipio().getEstado());
		//this.estadoChange();
		/*this.comboBoxMunicipio.setSelectedItem(cliente.getDireccion().getColonia().getPoblacion().getMunicipio());
		this.municipioChage();
		this.comboBoxPoblacion.setSelectedItem(cliente.getDireccion().getColonia().getPoblacion());
		this.poblacionChange();
		this.comboBoxColonia.setSelectedItem(cliente.getDireccion().getColonia());*/
